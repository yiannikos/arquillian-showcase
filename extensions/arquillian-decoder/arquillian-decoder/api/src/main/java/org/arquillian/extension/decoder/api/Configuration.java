 ...
 */
package org.arquillian.extension.decoder.api;
...
public abstract class Configuration
{
    ...
    {
        Validate.notNull(configuration, "Properties for configuration of Arquillian Decoder extension can not be a null object!");
     ...
     *
     * @throws DecoderConfigurationException when configuration of the extension is not valid
     */
    public abstract void validate() throws DecoderConfigurationException;
}
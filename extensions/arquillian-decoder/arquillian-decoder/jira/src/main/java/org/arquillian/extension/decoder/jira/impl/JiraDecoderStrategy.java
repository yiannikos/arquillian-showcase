...
import org.arquillian.extension.decoder.api.DecoderStrategy;
 ...
 *
 */
public class JiraDecoderStrategy implements DecoderStrategy
{
    private final JiraDecoderConfiguration decoderConfiguration;
    ...
    public JiraDecoderStrategy(JiraDecoderConfiguration decoderConfiguration)
    {
        Validate.notNull(decoderConfiguration, "Decoder configuration has to be set.");
        this.decoderConfiguration = decoderConfiguration;
    }

    public JiraDecoderStrategy issue(Issue jiraIssue)
    {
        this.jiraIssue = jiraIssue;
        return this;
    }

    public JiraDecoderStrategy annotation(Jira annotation)
    {
    ...
    public ExecutionDecision resolve()
    {
        ...
        if (decoderConfiguration.getForce())
        {
            return ExecutionDecision.execute(FORCING_EXECUTION_REASON_STRING);
        }

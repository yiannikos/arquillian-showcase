...
import org.arquillian.extension.decoder.api.Configuration;
 ...
 *
 */
public class JiraDecoderConfiguration extends Configuration
{
    private static final String EMPTY_STRING = "";

    private static final String DEFAULT_JIRA_SERVER_ADDRESS = "https://issues.jboss.org";

    private static final String DEFAULT_JIRA_CLOSING_MESSAGE = "This JIRA issue was automatically closed by %s with Arquillian Jira Decoder extension.";
    ...
    public URL getServerURL() throws DecoderConfigurationException
    {
        URL url = null;
        ...
        {
            throw new DecoderConfigurationException("Unable to construct URL of server from address: " + getServer());
        }

        return url;
    }

    public URI getServerURI() throws DecoderConfigurationException
    {
        URI uri = null;
        ...
        {
            throw new DecoderConfigurationException("Unable to construct URI of server from address: " + getServer());
        }
    ...
    @Override
    public void validate() throws DecoderConfigurationException
    {
        if (getServer().length() == 0)
        {
            throw new DecoderConfigurationException("Server URL is not set - it is an empty String.");
        }
    ...
    {
        final String server = System.getProperty("jira.decoder.server");
    ...
    {
        final String password = System.getProperty("jira.decoder.password");
    ...
    {
        final String username = System.getProperty("jira.decoder.username");
    ...
    {
        return Boolean.valueOf(System.getProperty("jira.decoder.force"));
    }

    private boolean resolveClosePassed()
    {
        return Boolean.valueOf(System.getProperty("jira.decoder.closepassed"));
    }
}

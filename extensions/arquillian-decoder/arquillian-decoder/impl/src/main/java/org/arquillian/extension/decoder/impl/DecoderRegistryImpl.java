 ...
 *
 */
public class DecoderRegistryImpl implements DecoderRegistry
{
    ...
    public List<Method> getMethodsForAnnotation(Class<? extends Annotation> annotationClass)
    {
        ...
        if (annotationClass.getAnnotation(Decoder.class) == null) {
            throw new IllegalStateException("Annotation class to get methods for is not annotated with Decoder class.");
        }

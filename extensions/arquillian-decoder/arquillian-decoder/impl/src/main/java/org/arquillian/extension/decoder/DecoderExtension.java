 ...
 *
 */
public class DecoderExtension implements LoadableExtension
{

    @Override
    public void register(ExtensionBuilder builder)
    {
        builder.observer(DecoderConfigurator.class);
        builder.observer(DecoderTestClassScanner.class);
        builder.observer(DecoderExecutionDecider.class);
    }

 ...
 *
 */
public class DecoderConfiguration extends Configuration
{
    ...
    public void validate() throws DecoderConfigurationException
    {
        if (getIgnore())
        {
            ...
            {
                throw new DecoderConfigurationException("You have set 'ignore' property to true and you set 'ignoreOnly' as well. "

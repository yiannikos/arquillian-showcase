 ...
 *
 */
public class DecoderExecutionDecider
{
    @Inject
    private Instance<DecoderRegistry> decoderRegistry;
    ...
    {
        for (Map.Entry<Method, List<Annotation>> entry : decoderRegistry.get().get().entrySet())
        {

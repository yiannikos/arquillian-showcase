...
public final class TestMethodExecutionRegister
{
    ...
    public static ExecutionDecision resolve(Method testMethod, Class<? extends Annotation> annotation)
    {
        ...
        if (annotationName.equals(TestMethodExecutionRegister.decoderConfiguration.getIgnoreOnly()))
        {
    ...
    public static void setConfigration(DecoderConfiguration decoderConfiguration)
    {
        Validate.notNull(decoderConfiguration, "DecoderConfiguration must be specified.");
        TestMethodExecutionRegister.decoderConfiguration = decoderConfiguration;
    }
}
